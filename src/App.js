...
function App() {
  ...
  return (
    <div className = "w-[100vw] h-[100vh] flex justify-center items-center bg-[#90EE90] flex-col gap-10">
      <div className = "text-[#2F4F4F] font-medium text-2xl">Increment & Decrement</div>
      ...
      <button onClick={ResetHandler} className="bg-[#191970] text-white px-5 py-2 rounded-sm text-lg">Reset</button>
    </div>
  );
}
